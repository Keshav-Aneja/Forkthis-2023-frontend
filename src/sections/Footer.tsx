...
export default function Footer() {
  return (
    <footer
      id="footer"
      className="flex justify-between items-center flex-col w-full  gap-[1.5rem] text-gray-300 bg-[#8A61FF33] px-[1rem] py-[2rem] mt-16"
    >
      {/* add  logo here */}
      ...
      <div className="flex w-full md:w-[30%] text-xl justify-around md:justify-center items-center font-gilroyRegular md:gap-[1.4rem]">
        ...
        <Link
          ...
          className="hover:text-[#8A61FF] hover:underline transition-colors duration-500 whitespace-nowrap"
        >
          About CSI
        </Link>
      </div>
