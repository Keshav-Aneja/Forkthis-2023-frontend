...
export default function Footer() {
  return (
    <footer className="flex justify-between items-center flex-col w-full  gap-[1.5rem] text-gray-300 bg-[#8A61FF33] px-[1rem] py-[2rem]">
        {/* add  logo here */}
        <div className="flex justify-between items-center w-[12%] ">
            <Image width={20} height={20} src="/sampleLogo.svg" alt="Logo"/>
            <h1 className="font-gilroyBlack text-4xl">ForkThis</h1>
        </div>

        <div className="flex  w-[30%] text-xl justify-between items-center font-gilroyRegular">
<p>First Link</p>
<p>First Link</p>
<p>First Link</p>
<p>First Link</p>
