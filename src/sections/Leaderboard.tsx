...
const Leaderboard: React.FC<rankings> = ({ rankHolders, rankScores }) => {
  return (
    // <div className="w-full mt-6 md:mt-0 lg:w-[60%] h-fit md:min-h-[50vh] bg-[#212426] rounded-2xl flex flex-col lg:flex-row justify-between">
    //   <div className="first w-full lg:w-[33%] lg:h-full flex flex-col lg:justify-end items-center order-2 md:order-1">
    //     <div className="container flex lg:h-full md:flex-row md:justify-between flex-col lg:flex-col justify-center items-center py-6 gap-2 md:px-6 lg:px-0">
    //       <Image
    ...
    //     </div>
    //   </div>
    //   <div className="first w-full lg:w-[33%] lg:h-full flex flex-col lg:justify-start items-center order-1 md:order-2">
    //     <div className="container flex flex-col md:flex-row lg:flex-col justify-center items-center py-6 gap-2  md:px-6 lg:px-0">
    //       <Image
    //         src="/images/gold-medal.png"
    //         alt="medal"
    //         width={100}
    ...
    //     </div>
    //   </div>
    //   <div className="first w-full lg:w-[33%] lg:h-full flex flex-col lg:justify-end items-center order-3 md:order-3">
    //     <div className="container flex flex-col md:flex-row lg:flex-col justify-center items-center py-6 gap-2  md:px-6 lg:px-0">
    //       <Image
    //         src="/images/gold-medal.png"
    //         alt="medal"
