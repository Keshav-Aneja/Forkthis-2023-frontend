...
export default function Sidebarrr() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="sm:w-[100%] sm:px-2 md:w-[60%] flex md:justify-between gap-5 items-center  md:gap-2 lg:flex-col lg:py-12 lg:gap-3 lg:w-[100%] lg:h-[30%] lg:hover:bg-black lg:px-5  lg:hover:text-sm duration-300 sm:justify-center">
          <Image
            className="md:w-[1.5rem] lg:w-[2.2rem] sm:hidden md:block"
        ...
        ></div>
        <div className="sm:w-[100%] sm:px-2 md:w-[60%]badges flex flex-col gap-5 md:flex-row lg:flex-col lg:gap-0 lg:w-[100%] lg:text-xs lg:h-[70%]">
          <div className="w-full flex justify-between gap-5 items-center md:justify-center md:gap-2 lg:flex-col lg:h-[33.3%]  lg:hover:bg-black  lg:hover:text-sm  duration-300 sm:justify-center">
            <Image
              className="md:w-[1.5rem] lg:w-[2.2rem] sm:hidden md:block"
          ...
          <Link
            href="/Resources"
            className="w-full flex justify-between gap-5 items-center md:justify-center md:gap-2 lg:flex-col lg:h-[33.3%]  lg:hover:bg-black  lg:hover:text-sm duration-300 sm:justify-center " 
          >
            <Image
              className="md:w-[1.5rem] lg:w-[2.2rem] sm:hidden md:block"
              src="/dashboard/awardIcon.png"
